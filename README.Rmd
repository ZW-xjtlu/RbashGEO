...
4. The most significant utility of this package is to reduce the repetitive coding, also it can generate compact results for downstream analysis.
...
At last, the obtained `SummarizedExperiment` object could be easily analyzed with other QC, inference, and learning work flows.
